...
/*
A simple demo of an unbuffered channel passing messages between two threads. It demonstrates the blocking nature of
unbuffered channels on both the sender and receiver.
*/
func main() {
	wg := sync.WaitGroup{}
	wg.Add(1)
